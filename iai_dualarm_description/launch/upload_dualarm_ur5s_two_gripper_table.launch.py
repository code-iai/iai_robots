...
def generate_launch_description():
    ...
    robot_description = Command([
        ...
        ' kinematics_config_left:=', kinematics_file,
        ' kinematics_config_right:=', kinematics_file
    ])

    return LaunchDescription([
        DeclareLaunchArgument('urdf_name', default_value='dualarm_ur5_two_gripper_table.urdf.xacro'),
